<x-app-layout>
    <div class="p-6">
        ...
        <form action="{{ route('transactions.withdraw') }}" method="POST" class="bg-white p-6 rounded shadow-md">
            @csrf
            ...
            <button class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">Withdraw</button>
        </form>
    </div>
</x-app-layout>
